  ...
  Widget build(BuildContext context) {
    ...
    ButtonStyle style = ButtonStyle(
      ...
      foregroundColor: WidgetStateProperty.resolveWith<Color?>((states) {
        ...
        // If text color is explicitly set, use it
        if (widget.options.textStyle?.color != null) {
          return widget.options.textStyle?.color;
        }
        // Otherwise, automatically choose text color based on button background
        final backgroundColor = widget.options.color;
        if (backgroundColor != null) {
          // Calculate luminance to determine if background is light or dark
          final luminance = backgroundColor.computeLuminance();
          // Use white text on dark backgrounds (>0.5), black text on light backgrounds
