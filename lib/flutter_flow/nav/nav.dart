...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CompanyInputPageWidget.routeName,
          path: CompanyInputPageWidget.routePath,
          builder: (context, params) => const CompanyInputPageWidget(),
        ),
        FFRoute(
          name: WebViewPageWidget.routeName,
          path: WebViewPageWidget.routePath,
          builder: (context, params) {
            final url = params.getParam<String>('url', ParamType.String)!;
            return WebViewPageWidget(url: url);
          },
        ),
